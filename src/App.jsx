        ...
        <div className="border-b border-slate-100 bg-white px-4 py-3 flex gap-2 flex-shrink-0">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full text-sm border border-slate-200 rounded-xl px-3.5 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-indigo-500/30 focus:border-indigo-400 font-mono"
            />
            <button
              type="button"
